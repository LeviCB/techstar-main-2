...
import 'package:techstar/screens/home/profile/followers_following/tabs/controllers/following_tab_controller.dart';
...
class _FollowingTabState extends State<FollowingTab> {
  FollowingTabController controller = Get.put(FollowingTabController());
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GetX(builder: (FollowingTabController controller) {
               ...
               Padding(
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: const UnderlineInputBorder(
                        borderSide: BorderSide(color: ColorRes.greyColor,width: 0.8 )),//
                    hintText: "Search",
                    hintStyle: Theme.of(context).textTheme.subtitle2!.merge(const TextStyle(
                    ...
                    prefixIcon: GestureDetector(
                        ...
                        child: const Padding(
                          ...
                          child: Icon(Icons.search, color: ColorRes.greyColor,size: 25,),
                        )),
                  ),
              ),
                ),
